##Реализация боковой (Off-Canvas) навигации для адаптивного (отзывчивого) сайта
...
*Финальный пример отзывчивого бокового меню с CSS трансформациями и переходами. Короткая ссылка: [bit.ly/offcanvas4][20]*
